...
local listfastattack = {'Tấn công bình thường','Tấn công nhanh','Tấn công siêu nhanh','Tấn công siêu siêu nhanh'}
	...
	if _G.FastAttackMode == "Tấn công nhanh" then
		_G.Fast_Delay = 0.10
	elseif _G.FastAttackMode == "Tấn công bình thường" then
		_G.Fast_Delay = 0.2
		elseif _G.FastAttackMode == "Tấn công siêu siêu nhanh" then
		_G.Fast_Delay = 0.01
	elseif _G.FastAttackMode == "Tấn công siêu nhanh" then
		_G.Fast_Delay = 0.05
	end
end)
...
teleportToChest(game.Players.LocalPlayer)
      Tabs.Main:AddButton({
        Title = "Nhập Hết Code",
...
if Third_Sea then
    ...
    spawn(function()
        while wait() do
            pcall(function()
                if _G.SailBoat then
                    if game:GetService("Workspace"):FindFirstChild("Enemies") and game:GetService("Workspace").Enemies:FindFirstChild("Shark") or not game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") or not game:GetService("Workspace").Enemies:FindFirstChild("Piranha") or not game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") then
    ...
    pcall(function()
        if _G.FastAttackEnabled then
            repeat wait(_G.DelayAttackPlayer)
               AttackNoCoolDown()
            until not _G.FastAttackEnabled
        end
    end)
end
end)
...
spawn(function()
    pcall(function()
        while wait(0.4) do
            if Auto_Law then
                if game:GetService("Workspace"):FindFirstChild("Enemies") and game:GetService("Workspace").Enemies:FindFirstChild("Order") and not game:GetService("ReplicatedStorage"):FindFirstChild("Order") then
